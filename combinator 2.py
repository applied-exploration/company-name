...
words_human_philosophy = ["atlas","fiction", "verve", "phenomena", "life", "spirit", "intellect", "time",  "beginning", "positivism", "empiricism", "Renaissance", "principle"]
...
words_human_nature = ["ocean", "people", "midnight", "sunrise", "sunset", "moon"]
words_human_thinking = ["magic", "thoughts", "conception", "conjectures"]
words_human_playful = ["play", "dreams"]
...
words_tech_experimental = ["future", "frontier", "phenomena"]
words_tech_intelligence = ["shortcuts", "complexity", "spark"]
words_tech_algorithm = ["centroids", "clusters", "algorithms", "function", "evolution","decisions", "randomness"]
words_tech_computing = ["structure", "compute", "engima", "logic", "machines", "byte", "engine"]
words_tech_scientific = ["axion", "Equilibrium", "joint", "friction", "synthesis", "projection", "hypersphere", "manifold", "vectors", "zeros", "discrete", "dimensions", "sequence", "factor",  "sphere", "fraction",   "effect", "theories", "calculus", "vertices", "matrices" "isometric", "negative"]
words_tech_abstract = ["loop"]
...
adjs_human_antropomorphism = ["secret", "thoughtful", "weird", "mysterious", "uncanny", "spark", "wunder", "unique",  "smart", "sharp", "imaginary", "original","magically", "perfect", "talking", "dancing", "human", "wicked", "lucky", "sweet", "angry", "beautiful", "handsome", "hungry", "brave"]
...
adjs_tech_applied_experimental = ["scientific", "exploratory"]
adjs_tech_algorithm = ["recurrence", "volatility", "stochastic", "unknown", "algorithmic", "rapid", "deterministic", "unresolved", "random"]
adjs_tech_inventive = ["future"]
adjs_tech_scientific = ["infinite", "discrete", "indiscrete", "high-dimensional", "parallel", "absolute", "relative", "quantum", "super-",  "exo", "nano", "isometric", "continuous", "singular", "negative"]
