...
words_human_philosophy = ["atlas","fiction", "verve", "anima", "phenomena", "life", "spirit", "intellect", "time",  "beginning", "positivism", "empiricism", "Renaissance", "principle"]
...
adjs_human_antropomorphism = ["spark", "wunder", "unique",  "smart", "virtuoso", "imaginary", "original","magical", "perfect", "talking", "dancing", "playing", "human", "wicked", "lucky", "sweet", "angry", "beautiful", "handsome", "hungry", "brave"]
