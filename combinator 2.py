...
things_human_philosophy = ["narrative", "theory of", "atlas","fiction", "verve", "phenomena", "life", "spirit", "intellect", "time",  "beginning", "positivism", "empiricism", "Renaissance", "principle"]
...
things_human_activities = ["desire", "darts", "canvas", "pieces"]
...
things_human_thinking = ["explorers", "magic", "thoughts", "conjectures"]
things_human_playful = ["play", "dreams", "-semi", "-ultra", "-alpha", "-beta",]
...
things_tech_intelligence = ["shortcuts", "complexity"]
...
adjs_human_philsophy = ["conceptual", "platonic", "hedonistic", "stoic", "empirical"]
adjs_human_relationship = ["likeminded", "connected", "solo", "rare", "generous", "tender", "archetypical", "quintessential", "mutual", "friendly"]
adjs_human_antropomorphism = ["blindfolded", "secret", "thoughtful", "weird", "mysterious", "uncanny", "spark", "wunder", "unique",  "smart", "sharp", "imaginary", "original","magically", "perfect", "talking", "dancing", "human", "wicked", "lucky", "sweet", "angry", "beautiful", "handsome", "hungry", "brave"]
adjs_human_playful = ["spooky", "playful", "joyful", "joyous", "cheerful", "jubilant", "exuberant", "spirited", "delightful", "upside-down", "thrilled", "euphoric", "affectionate", "wonder", "pleasant", "pleasing", "enchanted", "fascinating", "charismatic", "delightful", "youthful", "youth", "generation", "misplaced", "furry", "express", "improvised", "silly", "curious"]
